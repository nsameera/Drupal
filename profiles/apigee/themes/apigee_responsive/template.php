...
body .navbar-inverse .navbar-nav > .open > a:hover { color:$header_hover_txt_color; }
body header.navbar .nav > li > a { color: $header_txt_color; }
...
header.navbar.navbar-form, header.navbar.navbar-toggle {border-color: $header_hover_bg_color; }
.navbar-inverse .navbar-toggle, .navbar-inverse .navbar-toggle:hover, .navbar-inverse .navbar-toggle:focus,
.navbar-inverse .navbar-nav > .open > a, .navbar-inverse .navbar-nav > .open > a:hover, .navbar-inverse .navbar-nav > .open > a:focus,
.navbar-default .navbar-toggle:hover, .navbar-default .navbar-toggle:active, .navbar-default .navbar-toggle:focus,
.navbar-default .navbar-nav > .open > a, .navbar-default .navbar-nav > .open > a:hover, .navbar-default .navbar-nav > .open > a:focus,
header.navbar.navbar-nav > .open > a, header.navbar.navbar-nav > .open > a:hover, header.navbar.navbar-nav > .open > a:focus { background-color: $header_hover_bg_color; }
body header.navbar .nav .active > a, body .navbar .nav .active > a:hover, .navbar.navbar-fixed-top #main-menu li a:hover { background-color: $header_hover_bg_color; }
body header.navbar .nav > li > a:hover { color: $header_hover_txt_color; }
...
body .btn {background-color: $button_background_color;}
body .btn {color: $button_text_color;}
body .btn:hover, body .btn:focus, body .btn:active, body .open .dropdown-toggle.btn {background-color: $button_hover_background_color; color: $button_hover_text_color;}
...
function apigee_responsive_preprocess_page(&$vars) {
  ...
  if (module_exists('devconnect_developer_apps')) {
    $link_apps_html = '<span class="glyphicon glyphicon-pencil"></span>&nbsp;&nbsp; ' . t('My @app', array('@app' => _devconnect_developer_apps_get_app_label(TRUE)));
    $vars['myappslink'] = l($link_apps_html, $user_url . '/apps', array('html' => TRUE));
  }
  else {
    $vars['myappslink'] = '';
  }

  $link_profile_html = '<span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp; ' . t('Edit Profile');
  $vars['profilelink'] = l($link_profile_html, $user_url . '/edit', array('html' => TRUE));
  ...
  foreach ($dropdown_links as $dropdown_link) {
    $classes = implode(' ', $dropdown_link['classes']);
...
/**
 * Submit function for hook_form_FORM_ID_alter().
 */
 ...
 */
function apigee_responsive_apigee_company_switcher(array $variables) {

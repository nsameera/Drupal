...
class MintApiException extends \Exception
{
    ...
    private static $codes = array(
        self::DEVELOPER_LEGAL_COMPANY_NAME_NOT_SPECIFIED =>
            'Company name not specified, you need to specify company legal name to be able to accept a plan',
        self::DEVELOPER_ADDRESS_NOT_SPECIFIED =>
            'Address not specified, you need to specify address in your company profile to be able to accept a plan',
        ...
        self::START_DATE_EARLIER_THAN_PLAN_START_DATE =>
            'You cannot add a plan with a start date earlier than a plan start date.',
        self::START_DATE_LATER_THAN_PLAN_END_DATE =>
            'You cannot add a rate plan with start date going beyond rate plan end date',
        self::END_DATE_LATER_THAN_PLAN_END_DATE =>
            'You cannot end a rate plan with end date going beyond rate plan end date',
        self::END_DATE_EARLIER_THAN_START => 'You cannot end a plan with end date earlier than start date',
        self::DEVELOPER_ALREADY_ACCEPTED_RATE_PLAN_FOR_PRODUCT =>
            'You are adding a plan that overlaps with existing plans/products supported by existing plans.',
        ...
        self::ONLY_FUTURE_DEVELOPER_RATE_PLAN_CAN_BE_DELETED =>
            'Delete operation allowed only on future dated developer rate plan',
